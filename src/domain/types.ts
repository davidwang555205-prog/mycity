...
export interface CityProfile { id: string; name: string; dimensions: Record<Exclude<LifeDimension, "COST">, number>; actualCostLevel: number; climate: ClimatePreference; tags: string[]; strengths: string[]; tradeoffs: string[]; sources?: { label: string; type: "editorial" | "public" }[]; confidence?: Partial<Record<LifeDimension, number>> }
